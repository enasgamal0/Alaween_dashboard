...
export default {
  ...
  methods: {
    ...
    async resendVerificationCode() {
      ...
      const token = localStorage.getItem("alaween_admin_dashboard_forget_pass_token");
      try {
        ...
        localStorage.setItem(
          "alaween_admin_dashboard_verification_code",
          res.data.body.code
        );
    ...
    async submitForm() {
      ...
      if (this.verificationType == "reset-password") {
        try {
          ...
          this.clearFormInputs();
          localStorage.removeItem("alaween_admin_dashboard_email");
