  ...
  methods: {
    ...
    async submitForm() {
      ...
      this.$axios.defaults.headers.common["Authorization"] =
        "Bearer " +
        localStorage.getItem("alaween_admin_dashboard_forget_pass_token");
      ...
      const token = localStorage.getItem("alaween_admin_dashboard_reset_pass_token");
      try {
        await this.$axios({
          method: "POST",
        ...
        localStorage.removeItem("alaween_admin_dashboard_forget_pass_token");
        localStorage.removeItem("alaween_admin_dashboard_reset_pass_token");
