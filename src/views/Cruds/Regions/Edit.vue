<template>
  <div class="crud_form_wrapper">
    ...
    <div class="form_title_wrapper">
      <h4>{{ $t("PLACEHOLDERS.edit_new_region") }}</h4>
    </div>
  ...
  methods: {
    ...
    async showCity() {
      try {
        ...
        // this.regionPoints = res.data.data.Area.location.points;
        this.regionPoints = [
          { lat: 24.909791219297837, lng: 46.47973477630614 },
          { lat: 24.978276699522674, lng: 46.58135831146238 },
          { lat: 24.787668327498583, lng: 46.662382481384256 },
          { lat: 24.90356337928885, lng: 46.807951329040506 },
        ];
