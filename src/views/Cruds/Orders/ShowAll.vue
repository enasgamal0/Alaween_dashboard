    ...
    <main>
      ...
      >
        ...
        <template v-slot:[`item.id`]="{ item, index }">
          <p class="blue-grey--text text--darken-1 fs-3" v-if="!item.id">
            -
          </p>
          <p v-else>
            {{
     ...
     item.trans_status
        ...
        <template v-slot:[`item.actions`]="{ item }">
          <div class="actions">
            ...
            <a-tooltip placement="bottom" v-if="item.status_en == 'On_the_way_to_Unit'">
              <template slot="title">
            ...
            <a-tooltip placement="bottom" v-if="item.status_en == 'Cleaning_is_underway'">
              <template slot="title">
            ...
            <template v-if="item.status == 'new' || item.status == 'accepted_from_manager'">
              <a-tooltip placement="bottom">
                <template slot="title">
            ...
            <v-card>
              <form class="w-100">
                <base-input
                  ...
                  required
                />
                <base-input col="12" type="number" :placeholder="$t('PLACEHOLDERS.price')"
                  v-model.trim="servicePrice" required />
              </form>

              <v-card-actions>
                <v-btn class="modal_confirm_btn" @click="confirmAdd">{{
                  $t("BUTTONS.ok")
                }}</v-btn>
  ...
  computed: {
    ...
    activeStatuses() {
      return [
        ...
        {
          id: 4,
          name: this.$t("PLACEHOLDERS.rejected"),
          value: "rejected",
        },
      ];
    },
